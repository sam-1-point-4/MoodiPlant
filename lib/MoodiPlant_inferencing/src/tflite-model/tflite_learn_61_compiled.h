...
#ifndef tflite_learn_61_GEN_H
#define tflite_learn_61_GEN_H
...
TfLiteStatus tflite_learn_61_reset( void (*free)(void* ptr) );


// Returns the number of input tensors.
inline size_t tflite_learn_61_inputs() {
  return 1;
}
// Returns the number of output tensors.
inline size_t tflite_learn_61_outputs() {
  return 1;
}
